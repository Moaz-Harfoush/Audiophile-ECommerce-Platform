      ...
      <div className="absolute inset-0 z-10 flex items-center pointer-events-none">
        <div className="container w-full pointer-events-auto">
          <div className="w-full lg:w-[50%] text-center lg:text-left px-4 sm:px-12 md:px-24 lg:px-0 mx-auto lg:mx-0">
            ...
            <h1 className="text-3xl md:text-5xl lg:text-6xl font-bold text-white mb-6 tracking-wider uppercase leading-tight md:leading-[58px] lg:leading-[68px]">
              XX99 MARK II <br /> HEADPHONES
            </h1>
            <p className="text-[#C4C4C4] lg:text-[#979797] text-[15px] font-medium mb-10 max-w-sm mx-auto lg:mx-0 leading-relaxed normal-case">
